...
import com.mark.adapter.HomeMovieAdapter;
...
public class MovieDetailsActivity extends AppCompatActivity implements RateDialog.RateDialogListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        Yodo1Mas.getInstance().showBannerAd(MovieDetailsActivity.this);
        ...
        Yodo1Mas.getInstance().showRewardedAd(MovieDetailsActivity.this);
