...
import com.mark.adapter.HomeChannelAdapter;
...
import com.mark.fragment.TVExoPlayerFragment;
...
public class TVDetailsActivity extends AppCompatActivity implements RateDialog.RateDialogListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        Yodo1Mas.getInstance().showRewardedAd(TVDetailsActivity.this);
        ...
        Yodo1Mas.getInstance().showBannerAd(TVDetailsActivity.this);
